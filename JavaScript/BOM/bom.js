...
{
let window_whidth = window.innerWidth;
let window_height = window.innerHeight;
document.getElementById("window-size").innerHTML = `Размер окна браузера:${window_whidth}x${window_height}`;
}
...
function GetScreenProperties()
{
	...
	document.getElementById("pixel-depth").innerHTML = `${window.screen.pixelDepth}`;
}
