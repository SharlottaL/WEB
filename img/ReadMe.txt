...
2. Добавить в плейер кнопки 'Shuffle' и 'Loop';		DONE
3. Добавить кнопку 'DEL', которая удаляет песенку из плейлиста;	DONE
4. Добавить кнопку 'CLR', которая очищает плейлист;				DONE
